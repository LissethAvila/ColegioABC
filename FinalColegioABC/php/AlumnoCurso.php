		...
		<a href="#" class="navbar-brand2">Menu Alumno</a>
				...
				<div class="collapse navbar-collapse navHeaderCollapse">
					<ul class="navVer nav-tabs nav-stacked">
						...
						<li class="active"><a href="AlumnoCurso.php">Cursos</a></li>
...
<!--Datos-->
	<div class='col-xs-12 col-sm-6 col-md-6 ColorL'>
		<table class = "table table-bordered">
			<tr>
				<td colspan="5" align="center"><h2>********** CURSOS ASIGNADOS **********</h2></td><!--COLSPAN QUIERE DECIR QUE ESA FILA VA A OCUPAR LO MISMO QUE 4 COLUMNAS-->
			</tr>
			<tr>
				<td align="center"><h4>ID</h4></td>
				<td align="center"><h4>NOMBRE CURSO</h4></td>
			</tr>
			<?php
				$query = ("SELECT cu.Id as Idcur, cu.nombre as cur from Alumno a
							INNER JOIN carrera c ON a.Carrera_Id = c.Id 
							INNER JOIN detalleCurso dc ON dc.Carrera_Id = c.Id 
							INNER JOIN curso cu ON cu.Id = dc.Curso_Id where a.Id = '$_SESSION[idusuario]' group by cu.nombre order by cu.Id");
				$result = mysql_query($query, $con);
				while($row = mysql_fetch_array($result)){ ?>
				<tr class="">
					<td align="center"><?php echo $row["Idcur"];?></td>
