		...
		<a href="#" class="navbar-brand2">Menu Alumno</a>
				...
				<div class="collapse navbar-collapse navHeaderCollapse">
					<ul class="navVer nav-tabs nav-stacked">
						...
						<li class="active"><a href="AlumnoNota.php">Notas</a></li>
...
<!--Datos-->
	<div class='col-xs-12 col-sm-6 col-md-6 ColorL'>
		<table class = "table  tableSesion table-bordered">
			<tr>
				<td colspan="5" align="center"><h2>*** CONTROL DE NOTAS CICLO 2014 ***</h2></td><!--COLSPAN QUIERE DECIR QUE ESA FILA VA A OCUPAR LO MISMO QUE 4 COLUMNAS-->
			</tr>
			<tr>
				<td align="center"><h4>ID</h4></td>
				<td align="center"><h4>NOMBRE ALUMNO</h4></td>
				<td align="center"><h4>CURSO</h4></td>
				<td align="center"><h4>TIPO_NOTA</h4></td>
				<td align="center"><h4>NOTA</h4></td>
			</tr>
			<?php
				$query = ("SELECT a.Id as Ida,a.Nombre as alumnoa,cu.nombre as cur, n.Nota as notaa, tn.Nombre as tin from Alumno a
							...
							INNER JOIN nota n ON cu.id = n.Curso_Id 
							INNER JOIN tipo_nota tn ON n.Tipo_Nota_Id = tn.Id where a.Id = '$_SESSION[idusuario]' Order by cu.nombre;");
				$result = mysql_query($query, $con);
				while($row = mysql_fetch_array($result)){ ?>
				<tr class="">
					<td align="center"><?php echo $row["Ida"];?></td>
					<td><?php echo $row["alumnoa"];?></td>
					<td><?php echo $row["cur"];?></td>
					<td><?php echo $row["tin"];?></td>
					<td align="center"><?php echo $row["notaa"];?></td>				
				</tr>
			<?php 
				}
			?>
	...
	<table class = "table  tableSesion table-bordered">
			...
			<tr>
				<td align="center"><h4>CURSO</h4></td>
				<td align="center"><h4>PARCIAL 1</h4></td>
				<td align="center"><h4>PARCIAL 2</h4></td>
				<td align="center"><h4>ZONA</h4></td>
				<td align="center"><h4>NOTAFINAL</h4></td>
			</tr>
		<?php 
			$query = ("SELECT a.Id as Ida,a.Nombre as alumnoa,cu.nombre as cur, n.Nota as notaa, tn.Nombre as tin from Alumno a
							INNER JOIN Carrera c ON a.Carrera_Id = c.Id 
			...
			while ($fila = mysql_fetch_array($result)) { ?>
				<tr>
					<td><?php echo $fila["cur"];  ?></td>

					<?php for ($i=0; $i < $fila["tin"]; $i++) { ?>
						
						<td><?php echo $fila["notaa"] ?></td>
