		...
		<a href="#" class="navbar-brand2">Menu Catedralico</a>
				...
				<div class="collapse navbar-collapse navHeaderCollapse">
					<ul class="navVer nav-tabs nav-stacked">
						...
						<li class="active"><a href="IngresarNota.php">Ingresar Notas</a></li>
					</ul>
				</div>
			</div>
		</div>
...
<form ACTION ='IngresarNota.php' METHOD = POST>	
...
<!--Datos-->
	...
	<form ACTION ='IngresarNota.php' METHOD = POST>
		<table class="tableSesion " >
			...
			<tr>
				<td>Carrera: </td><td><select name="Carrera">
...
<?php 
			...
			$consulta = mysql_query("SELECT a.Id, a.Nombre
				...
				WHERE a.Carrera_Id = '$_POST[Carrera]' ", $conexion);
		...
		while ($filas = mysql_fetch_array($consulta))
		{
			...
			echo "<tr>
					...
					<td class='tabla'><input name = 'calif' type='text'></td>
