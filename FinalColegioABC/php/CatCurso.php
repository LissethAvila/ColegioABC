		...
		<a href="#" class="navbar-brand2">Menu Catedralico</a>
				...
				<div class="collapse navbar-collapse navHeaderCollapse">
					<ul class="navVer nav-tabs nav-stacked">
						...
						<li class="active"><a href="CatCurso.php">Listado de Cursos</a></li>
...
<form ACTION ='CatCurso.php' METHOD = POST>	
...
<!--Datos-->
	<div class='col-xs-12 col-sm-6 col-md-6 ColorL'>
		<table class = "table tableSesion table-bordered">
			<tr>
				<td colspan="5" align="center"><h2>****** CURSOS IMPARTIDOS ******</h2></td><!--COLSPAN QUIERE DECIR QUE ESA FILA VA A OCUPAR LO MISMO QUE 4 COLUMNAS-->
			</tr>
			<tr>
			...
			$query = ("SELECT cur.Id, cur.Nombre
				from catedratico cat Inner Join detalleCatedratico dcat on cat.Id = dcat.Catedratico_Id 
				Inner Join curso cur on cur.Id = dcat.Curso_Id
				WHERE cat.Id = '$_SESSION[idusuario]'");
